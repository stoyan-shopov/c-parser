...
static const struct word custom_dict[] = {
	...
	MKWORD(custom_dict,		__COUNTER__,	"}declaration-without-declarator-list",	do_declaration_end),
	MKWORD(custom_dict,		__COUNTER__,	"}declaration-with-declarator-list",	do_declaration_end),
	MKWORD(custom_dict,		__COUNTER__,	"declaration-without-declarator-list{",	do_declaration_without_declarator_list_begin),
	MKWORD(custom_dict,		__COUNTER__,	"declaration-with-declarator-list{",	do_declaration_with_declarator_list_begin),
